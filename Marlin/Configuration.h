...
#define Z_SERVO_ANGLES { 168, 90 } // Z Servo Deploy and Stow angles
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -38, -9, -1 }
...
#define UBL_NO_MANUAL_PROBE
#define UBL_NO_LCD_SUPPORT
#define UBL_NO_J_MESH_TILTING
#define UBL_NO_ WHAT_CMD
